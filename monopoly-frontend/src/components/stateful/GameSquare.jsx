...
class GameSquare extends React.Component {
  ...
  render() {
    ...
    const bottomRow = this.props.squares.filter(square => square.spaceNumber > 20 && square.spaceNumber < 32)
    const topRow = this.props.squares.filter(square => square.spaceNumber < 12)
